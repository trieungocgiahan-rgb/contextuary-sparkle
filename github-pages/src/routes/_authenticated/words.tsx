...
import { createWord, deleteWord, updateWord, type WordRow } from "@/lib/vocab.api";
...
import type { SatWord } from "@/lib/daily-picks.api";
import { PracticePickerDialog } from "@/components/practice-picker";
import { validateWord } from "@/lib/validation.api";
...
function WordsPage() {
  ...
  const upd = updateWord;
  const generate = generateWordDetails;
  const validate = validateWord;
